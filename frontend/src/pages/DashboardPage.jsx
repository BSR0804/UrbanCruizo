                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col md:flex-row lg:flex-col items-center md:items-end gap-6 w-full lg:w-auto">
                                            ...
                                            <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 transition-all">
                                                ...
                                                {(booking.status !== 'cancelled' && booking.status !== 'rejected' && booking.status !== 'completed' && new Date(booking.endDate) > new Date()) && (
                                                    <button
                                                        onClick={() => {
                                                            setSelectedBooking(booking);
                                                            setIsEditOpen(true);
                                                ...
                                                {((booking.status === 'pending_approval' || booking.status === 'approved') && new Date(booking.startDate) > new Date()) && (
                                                    <button
                                                        onClick={() => {
                                                            setSelectedBooking(booking);
